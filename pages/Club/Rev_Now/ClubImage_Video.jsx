...
import Monkeys from '../../../public/images/Rev-Now.jpg';
import ClubDescription from '../../components/ClubDescription';

const ClubImage_Video = () => {
  return (
    <>
      <div className="text-5xl text-center bg-gray-400 text-white hover:text-blue-600 textstyle">Rev-Now</div>
      ...
      <div className='flex justify-between items-center bg-gray-500 p-5 max-sm:flex-col'>
        ...
        <div className='w-1/2'>
          <iframe 
            src="https://www.youtube.com/embed/kZHNWiipjk4" 
            frameBorder="0"
            width="100%"
            height="450"
            allowFullScreen
